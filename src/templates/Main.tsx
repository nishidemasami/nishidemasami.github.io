...
const Main = (props: IMainProps) => (
	<div className="antialiased w-full text-gray-700 md:px-0 sm:flex min-h-screen">
		...
		<div className="mx-auto float-left px-3 w-full max-sm sm:w-3/4 bg-slate-100 min-h-screen">
		...
		<div className="w-full sm:w-1/4 float-right sm:sticky shadow-[-2px_0px_3px_0px_rgba(0,0,0,0.12)] sm:h-full sm:flex sm:top-auto sm:self-end sm:bottom-0 min-h-screen">
