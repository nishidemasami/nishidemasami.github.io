...
import {
  sunshineRaybackground,
  sunshineRaybackgroundSunshineRays,
} from "./Background.module.scss";

function SunshineRayBackground(): JSX.Element {
  return (
    <div className={sunshineRaybackground}>
      <svg className={sunshineRaybackgroundSunshineRays} viewBox="20 20 40 40">
        <circle
          cx="40"
          cy="40"
          r="15"
