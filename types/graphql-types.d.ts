...
export type CategoryPageQuery = { allMdx: { edges: Array<{ node: { frontmatter?: Maybe<Pick<MdxFrontmatter, 'slug' | 'date' | 'description' | 'category' | 'title'>> } }> } };
...
export type IndexTemplateQuery = { allMdx: { edges: Array<{ node: { frontmatter?: Maybe<Pick<MdxFrontmatter, 'slug' | 'title' | 'date' | 'category' | 'description'>> } }> } };
...
export type PageBySlugQuery = { mdx?: Maybe<(
    Pick<Mdx, 'id' | 'body'>
    & { frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'date' | 'description' | 'socialImage'>> }
  )> };
...
export type PostBySlugQuery = { mdx?: Maybe<(
    Pick<Mdx, 'id' | 'body'>
    & { frontmatter?: Maybe<Pick<MdxFrontmatter, 'slug' | 'date' | 'description' | 'tags' | 'title' | 'socialImage'>> }
  )> };
...
export type TagPageQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'subtitle'>> }>, allMdx: { edges: Array<{ node: { frontmatter?: Maybe<Pick<MdxFrontmatter, 'slug' | 'category' | 'title' | 'date' | 'description'>> } }> } };
